...
export const GlobalStyles = () => (
  <style>{`
    ...
    .hero-section { 
        ...
        animation: fade-slide-in 0.8s cubic-bezier(0.34, 1.56, 0.64, 1);
    }
    ...
    .glass-overlay {
        position: fixed;
        inset: 0;
        background: radial-gradient(circle at 20% 20%, rgba(98,129,65,0.12), transparent 40%),
    ...
    @keyframes pulse-glow {
        0%, 100% { box-shadow: 0 20px 60px var(--shadow-soft); }
        50% { box-shadow: 0 25px 80px var(--shadow-soft); }
    }
    .promo-bubble-text {
    ...
    @keyframes pulse-dot {
        0% { box-shadow: 0 0 0 0 rgba(98,129,65,0.6); }
        70% { box-shadow: 0 0 0 10px rgba(98,129,65,0); }
        100% { box-shadow: 0 0 0 0 rgba(98,129,65,0); }
    }
    ...
    .home-hero::before {
        ...
        width: 600px;
        height: 600px;
        background: radial-gradient(circle, rgba(98,129,65,0.15), transparent 70%);
        border-radius: 50%;
    ...
    .reviews-column:nth-child(1) .home-review-card:nth-child(1) { animation-delay: 0.1s; }
    .reviews-column:nth-child(1) .home-review-card:nth-child(2) { animation-delay: 0.2s; }
    .reviews-column:nth-child(1) .home-review-card:nth-child(3) { animation-delay: 0.3s; }
    .reviews-column:nth-child(2) .home-review-card:nth-child(1) { animation-delay: 0.15s; }
    .reviews-column:nth-child(2) .home-review-card:nth-child(2) { animation-delay: 0.25s; }
    .reviews-column:nth-child(2) .home-review-card:nth-child(3) { animation-delay: 0.35s; }
    @keyframes slide-up {
        from { opacity: 0; transform: translateY(20px); }
        to { opacity: 1; transform: translateY(0); }
    }
    .home-review-card:hover {
        ...
        box-shadow: 0 20px 50px rgba(64, 83, 76, 0.25);
    ...
    .btn:hover {
        ...
        box-shadow: 0 15px 40px rgba(64, 83, 76, 0.3) !important;
    }
    .btn:active {
    ...
    input:focus, textarea:focus, select:focus {
        ...
        box-shadow: 0 0 0 3px rgba(214, 189, 152, 0.2) !important;
    }
    ...
    .reviews-column:nth-child(1) .home-review-card:nth-child(2) { animation-delay: 0.2s; }
    .reviews-column:nth-child(1) .home-review-card:nth-child(3) { animation-delay: 0.3s; }
    .reviews-column:nth-child(1) .home-review-card:nth-child(4) { animation-delay: 0.4s; }
    .reviews-column:nth-child(1) .home-review-card:nth-child(5) { animation-delay: 0.5s; }
    .reviews-column:nth-child(1) .home-review-card:nth-child(6) { animation-delay: 0.6s; }
    .reviews-column:nth-child(2) .home-review-card:nth-child(1) { animation-delay: 0.15s; }
    .reviews-column:nth-child(2) .home-review-card:nth-child(2) { animation-delay: 0.25s; }
    .reviews-column:nth-child(2) .home-review-card:nth-child(3) { animation-delay: 0.35s; }
    .reviews-column:nth-child(2) .home-review-card:nth-child(4) { animation-delay: 0.45s; }
    .reviews-column:nth-child(2) .home-review-card:nth-child(5) { animation-delay: 0.55s; }
    .reviews-column:nth-child(2) .home-review-card:nth-child(6) { animation-delay: 0.65s; }
    ...
    .home-review-card:hover {
        ...
        box-shadow: 0 25px 60px rgba(64, 83, 76, 0.35) !important;
        border-color: var(--accent-warm) !important;
    }
